                    ...
                    Row(
                      children: <Widget>[
                        ...
                        if (displayValues != DisplayValues.none &&
                          ...
                          Text(
                            geometryActive!
                                ? label?.toLowerCase().contains('line') ?? false
                                    ? 'Line width : ${_numberFormat.format(field.value)} px'
                                    : label?.toLowerCase().contains('point') ??
                                            false
                                        ? 'Radius : ${_numberFormat.format(field.value)} px'
